...
class villageHandler(osmium.SimpleHandler):
    """Extracts village polygon features (visible in satellite imagery) from the map.
    """

    # village=* to discard because these features are not vislible in satellite imagery
    village_filter = set(
